...
class _LoginScreenState extends ConsumerState<LoginScreen>
  ...
  Widget _buildSendOtpButton(AuthState authState) {
    final role = ref.watch(selectedRoleProvider) ?? AppRole.consumer;
    return SizedBox(
        ...
        onPressed: authState.isLoading
            ...
            : () {
                ref
                    ...
                    .sendOtp(_phoneController.text, role: role);
              },
    ...
    return SizedBox(
      ...
      child: OutlinedButton(
        onPressed: authState.isLoading
            ? null
            : () {
                ref.read(authControllerProvider.notifier).signInWithGoogle(role: role);
              },
